        ...
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div onClick={()=>navigate('/cart')} className="relative cursor-pointer">
                    ...
                    <button className="absolute -top-2 -right-3 text-xs text-white bg-primary-dull w-4.5 h-4.5 rounded-full">{getCartCount()}</button>
                </div>
                ...
                {!user ? (
                    ...
                    <div className='relative group'>
                        ...
                        <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 px-2 w-30 rounded-md text-sm z-10'>
            ...
            <div className='flex gap-9 items-center sm:hidden'>
                <div onClick={()=>navigate('/cart')} className="relative cursor-pointer">
                    <img src={assets.nav_cart_icon} className='w-6 opacity-80'/>
                    <button className="absolute -top-2 -right-3 text-xs text-white bg-primary-dull w-4.5 h-4.5 rounded-full">{getCartCount()}</button>
                </div>
