...
const Cart = () => {
    ...
    const {axios,setCartItems,products,user,currency,cartItems,removeFromCart,getCartCount,updateCartItem,navigate,getCartAmount} = useAppContext()
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                {addresses.map((address,ind)=>(
                                    <p key={ind} onClick={() => {setSelectedAddress(address);setShowAddress(false)}} className="text-gray-500 p-2 hover:bg-gray-100">
